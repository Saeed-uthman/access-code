...
CELERY_BEAT_SCHEDULE = {
    'cleanup-failed-transactions': {
        'task': 'transactions.tasks.cleanup_failed_transactions',
    ...
    'expire-old-access-codes': {
        'task': 'access_code.tasks.expire_old_codes',
        'schedule': timedelta(hours=1),
    },
}

WHATSAPP_SUPPORT_NUMBER = config('WHATSAPP_SUPPORT_NUMBER', default='+2349060595221')
